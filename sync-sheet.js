...
// Honor GOOGLE_CREDENTIALS from .env (as the deck teaches); default to ./credentials.json.
const CREDENTIALS_PATH = path.resolve(__dirname, process.env.GOOGLE_CREDENTIALS || "credentials.json");
